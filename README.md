...
- **Online intelligence:** optional Gemini 3.6 Flash provider with a user-supplied API key. No key is embedded in source or APK.
...
4. validates Gemini 3.6 Flash generation using the repository secret,
5. runs unit tests,
6. runs Android lint,
7. builds `app-debug.apk`,
8. uploads `friday-debug-apk`.
