...
Audit pass: repository workflow is also present on main so the CI definition is recognized for the final PR line.

Final validation trigger: source and workflow were synchronized after the CI workflow activation fix.
